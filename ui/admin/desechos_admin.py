...
def badge_estado(estado: str):
    ...
    return ft.Container(
        ...
        border=ft.Border.all(
            1,
            ft.Colors.with_opacity(0.5, color),
        ),
    )
...
def accion_reporte(rep, on_asignar=None):
    ...
    if rep.estado == "Pendiente":
        return ft.ElevatedButton(
            ...
            color="#fff",
            tooltip=(
                "Asignar un chofer disponible para la recolección "
                "de los neumáticos reportados."
            ),
            style=ft.ButtonStyle(
                shape=ft.RoundedRectangleBorder(radius=8)
            ),
            on_click=(
                lambda e: on_asignar(rep)
            ) if on_asignar else None,
        )
        ...
        return ft.Row(
            controls=[
                ft.Icon(
                    ...
                    size=16,
                    color=STAT_BLUE,
                    tooltip="Chofer asignado al reporte.",
                ),
                ft.Text(
        ...
        return ft.Row(
            controls=[
                ft.Icon(
                    ...
                    size=16,
                    color=STAT_TEAL,
                    tooltip="La recolección de este reporte fue completada.",
                ),
                ft.Text(
                    "Completado",
                    size=12,
...
def tarjeta_reporte(rep, on_click=None, on_asignar=None):
    ...
    return ft.Container(
        ...
        # Tooltip general de la tarjeta.
        tooltip=(
            "Seleccionar este reporte para consultar sus detalles, "
            "gestionar la asignación o realizar acciones disponibles."
        ),
...
def detalle_reporte_card(
    ...
    if rep.estado == "Pendiente":
        boton_principal = ft.ElevatedButton(
            ...
            tooltip=(
                "Seleccionar un chofer disponible para realizar "
                "la recolección de este reporte."
            ),
            ...
            ) if on_accion_principal else None,
        )
        ...
        boton_principal = ft.ElevatedButton(
            ...
            tooltip=(
                "Marcar el reporte como completado una vez que "
                "la recolección haya sido realizada."
            ),
    ...
    botones = [
        ft.OutlinedButton(
            ...
            tooltip=(
                "Eliminar permanentemente este reporte. "
        ...
        ft.OutlinedButton(
            ...
            tooltip="Cerrar la ventana de detalles.",
                ...
                ft.Row(
                    controls=[
                        ...
                        ft.IconButton(
                            ...
                            tooltip="Cerrar detalles del reporte.",
...
def formulario_asignar_chofer(
    ...
    dropdown = ft.Dropdown(
        ...
        tooltip=(
            "Selecciona el chofer que realizará la recolección "
            "de los neumáticos reportados."
        ),
                ...
                ft.Row(
                    controls=[
                        ...
                        ft.IconButton(
                            ...
                            tooltip="Cerrar sin realizar la asignación.",
                ...
                ft.Row(
                    controls=[
                        ft.OutlinedButton(
                            ...
                            tooltip=(
                                "Cancelar la asignación y regresar "
                        ...
                        ft.ElevatedButton(
                            ...
                            tooltip=(
                                "Asignar el chofer seleccionado "
                                "al reporte."
                            ),
                ...
                ft.Row(
                    controls=[
                        ...
                        ft.IconButton(
                            ...
                            tooltip=(
                                "Cerrar esta ventana sin eliminar "
                                "el reporte."
                            ),
...
def boton_informacion():
    return ft.Container(
        content=ft.IconButton(
            ...
            # Tooltip profesional y contextual.
            tooltip=(
                "Consultar información sobre la gestión "
                "de reportes de desecho."
            ),
