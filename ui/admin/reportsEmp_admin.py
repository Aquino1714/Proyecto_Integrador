    ...
    if rep.estado == "Pendiente":
        return ft.ElevatedButton(
            ...
            tooltip=(
                ...
                "una vez que la situación haya sido atendida."
            ),
            ...
            on_click=(
                lambda e: on_resolver(rep)
            ) if on_resolver else None,
        )
    ...
    return ft.Row(
        controls=[
            ft.Icon(
                ...
                tooltip=(
                    "Este reporte ha sido atendido "
                    "y marcado como resuelto."
                ),
            ),
...
def tarjeta_reporte(
    ...
    return ft.Container(
        ...
        tooltip=(
            "Seleccionar este reporte para consultar "
            "la información completa y gestionar sus acciones."
        ),
                    ...
                    controls=[
                        ft.Column(
                            ...
                            controls=[
                                ft.Text(
                                    f"{rep.asunto} — "
                                    f"{rep.empleado_nombre} "
                                    f"(EMP-{rep.empleado_id:03d})",
                                    size=14,
                                ...
                                ft.Text(
                                    (rep.descripcion or "")[:120]
                                    + (
                                        "..."
                                        if rep.descripcion
                                        and len(rep.descripcion) > 120
                                        else ""
                                    ),
                                    size=12,
                ...
                ft.Row(
                    controls=[
                        ...
                        ft.IconButton(
                            ...
                            tooltip=(
                                "Cerrar los detalles del reporte."
                            ),
    ...
    return ft.Container(
        content=ft.IconButton(
            ...
            tooltip=(
                ...
                "gestión de reportes de empleados."
            ),
...
def reportes_empleados_content(page: ft.Page):
    ...
    def _refrescar():
        nuevos = ReportsEmpDAO().get_all_admin()
                    ...
                    controls=[
                        ft.Row(
                            controls=[
                                ...
                                ft.Text(
                                    "Bandeja de Reportes de Empleados",
                                    size=17,
                                    weight=ft.FontWeight.BOLD,
                                    color=TEXT_PRIMARY,
                                ),
                        ...
                        ft.Text(
                            "Reportes enviados por choferes, "
                            "recepción, almacén y trituración.",
                            size=12,
                            color=TEXT_SECONDARY,
                        ),
