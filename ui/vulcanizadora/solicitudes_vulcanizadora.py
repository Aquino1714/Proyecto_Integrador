...
def badge_estado(estado: str):
    ...
    return ft.Container(
        ...
        tooltip=f"Estado actual del reporte: {estado}",
    )
...
def accion_reporte(rep, on_editar=None):
    ...
    if rep.estado == "Pendiente":
        return ft.OutlinedButton(
            ...
            tooltip="Editar la cantidad de neumáticos y los detalles del reporte",
        ...
        return ft.Row(
            controls=[
                ft.Icon(
                    ...
                    size=16,
                    color=STAT_BLUE,
                    tooltip="Reporte asignado a un empleado para recolección",
                ),
        ...
        return ft.Row(
            controls=[
                ft.Icon(
                    ...
                    size=16,
                    color=STAT_TEAL,
                    tooltip="La recolección del reporte ha sido completada",
                ),
    ...
    return ft.Text(
        ...
        color="#9ca3af",
        weight=ft.FontWeight.W_600,
        tooltip="Este reporte fue cancelado",
    )
...
def tarjeta_reporte(
    ...
    id_display = (
        f"VULC-{rep.vulcanizadora_id:02d}"
    )
    ...
    return ft.Container(
        ...
        tooltip="Haz clic para consultar los detalles del reporte",

        on_click=(
            lambda e: on_click(rep)
        )
        if on_click
        else None,
                    ...
                    controls=[
                        ft.Column(
                            ...
                            controls=[
                                ...
                                ft.Text(
                                    "Volumen reportado para trituración: "
...
def _descripcion_reporte(rep):
    ...
    if rep.detalles and rep.detalles.strip():
        ...
        texto = (
            f"Se informa que durante la jornada del día se generó "
            f"un volumen total de {rep.cantidad_llantas} neumáticos "
            f"de desecho listos para trituración. Aún no se ha "
            f"registrado una descripción detallada por parte de "
            f"la vulcanizadora."
        )
...
def detalle_reporte_card(
    rep,
    on_cerrar=None,
    on_eliminar=None,
    on_accion_principal=None,
):
    id_display = (
        f"VULC-{rep.vulcanizadora_id:02d}"
    )
    ...
    if rep.estado == "Pendiente":
        boton_principal = ft.ElevatedButton(
            ...
            tooltip="Modificar la información de este reporte",
            ...
            on_click=(
                lambda e: on_accion_principal(rep)
            )
            if on_accion_principal
            else None,
        )
    ...
    botones = [
        ft.OutlinedButton(
            ...
            tooltip="Eliminar este reporte de forma permanente",
...
def formulario_editar_reporte(
    ...
    campo_cantidad = ft.TextField(
        ...
        tooltip="Cantidad de neumáticos incluidos en el reporte",
    )
    ...
    campo_detalles = ft.TextField(
        ...
        tooltip="Agrega información adicional sobre los neumáticos",
    )
    ...
    def _confirmar(e):
        ...
        if (
            ...
            error_text.value = (
                "Ingresa una cantidad válida de neumáticos."
            )
                ...
                ft.Row(
                    controls=[
                        ...
                        ft.IconButton(
                            ...
                            tooltip="Cerrar edición sin guardar",
                ...
                ft.Row(
                    controls=[
                        ...
                        ft.ElevatedButton(
                            ...
                            tooltip="Guardar las modificaciones del reporte",
...
def formulario_nuevo_reporte(
    ...
    campo_cantidad = ft.TextField(
        ...
        tooltip="Indica cuántos neumáticos están listos para recolección",
    )
    ...
    campo_detalles = ft.TextField(
        ...
        tooltip="Agrega información adicional del reporte",
    )
    ...
    return ft.Container(
        ...
        content=ft.Column(
            ...
            controls=[
                ft.Row(
                    controls=[
                        ...
                        ft.IconButton(
                            ...
                            tooltip="Cerrar sin crear el reporte",
                ...
                ft.Text(
                    "Reporta el volumen de neumáticos listos "
                ...
                ft.Row(
                    controls=[
                        ft.OutlinedButton(
                            ...
                            tooltip="Cancelar la creación del reporte",
                        ...
                        ft.ElevatedButton(
                            ...
                            tooltip="Registrar y enviar el reporte de desecho",
                ...
                ft.Row(
                    controls=[
                        ...
                        ft.ElevatedButton(
                            ...
                            tooltip="Eliminar definitivamente este reporte",
...
def boton_informacion():
    return ft.Container(
        content=ft.IconButton(
            ...
            tooltip="Información sobre Neusomic",
...
def desechos_content(
    ...
    async def _swap_contenido(
        ...
        modal_card_ref.current.content = (
            nuevo_control
        )
    ...
    async def _abrir_con_contenido(
        control
    ):
    ...
    def confirmar_editar(
        ...
        existente = (
            ReportVulDAO()
            .get_by_id_admin(reporte_id)
        )

        if (
            existente is None
            or existente.vulcanizadora_id
            != vulcanizadora_id
        ):
            cerrar_modal()
            return

        existente.cantidad_llantas = (
            cantidad_llantas
        )
    ...
    def abrir_nuevo_reporte():
        ...
        formulario = formulario_nuevo_reporte(
            on_confirmar=confirmar_nuevo_reporte,
            on_cancelar=cerrar_modal,
        )
    ...
    def manejar_accion_principal(rep):
        ...
        if rep.estado == "Pendiente":
            ...
            ReportVulDAO().marcar_completado(
                rep.reporte_id
            )
                        ...
                        ft.Row(
                            controls=[
                                ft.Icon(
                                    ...
                                    tooltip="Reportes de desecho activos",
                                ),
                                ...
                                ft.ElevatedButton(
                                    ...
                                    tooltip="Crear un nuevo reporte de desecho",
